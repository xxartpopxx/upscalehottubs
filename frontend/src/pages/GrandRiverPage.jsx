...
const GrandRiverPage = () => {
  ...
  const availableSeries = useMemo(() => {
    return getUniqueSeries(GRAND_RIVER_PRODUCTS);
  }, []);

  // Apply filters and sorting
  const filteredProducts = useMemo(() => {
    const filtered = filterProducts(GRAND_RIVER_PRODUCTS, {
      ...filters,
  ...
  return (
    <>
      ...
      <div className="pt-40 md:pt-48 lg:pt-56 xl:pt-64 pb-20" data-testid="grand-river-page" style={{

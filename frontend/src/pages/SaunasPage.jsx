  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Shop premium barrel saunas and infrared saunas at Upstate Hot Tubs. RELAX-RENEW-REPEAT. Live your healthiest life while enjoying a vacation everyday at home. American made and proud of it. Free delivery in South Carolina." />
        <meta name="keywords" content="saunas, barrel saunas, infrared sauna, traditional sauna, outdoor sauna, wellness, SaunaLife, Upstate Hot Tubs, Greenville SC" />
      ...
      <div className="pt-36 pb-20" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #e8f4fc 20%, #d0e8f7 50%, #b8dcf2 80%, #a0d0ed 100%)' }} data-testid="saunas-page">
